...
class FlowerPlants extends StatelessWidget {
  const FlowerPlants({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
        itemCount: AppColors.flowerPlants.length,
            ...
            child: Card(
              ...
              child: Column(
                children: [
                  ...
                  /// plant name
                  const MyText(title: "Flower Plant",fontWeight: FontWeight.w500,),
